 ...
 */
@ActivityScope
public class BusinessInfoPresenter extends BasePresenter<BusinessInfoContract.Model, BusinessInfoContract.View> {
    @Inject
    ...
    @Inject
    public BusinessInfoPresenter(BusinessInfoContract.Model model, BusinessInfoContract.View rootView) {
