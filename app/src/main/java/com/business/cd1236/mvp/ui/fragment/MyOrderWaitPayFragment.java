 ...
 * ================================================
 */
public class MyOrderWaitPayFragment extends MyBaseFragment<MyOrderWaitPayPresenter> implements MyOrderWaitPayContract.View {

    public static MyOrderWaitPayFragment newInstance() {
        MyOrderWaitPayFragment fragment = new MyOrderWaitPayFragment();
        return fragment;
    }

    @Override
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerMyOrderWaitPayComponent //如找不到该类,请编译一下项目
                .builder()
