 ...
 */
@ActivityScope
public class BusinessBasicInfoPresenter extends BasePresenter<BusinessBasicInfoContract.Model, BusinessBasicInfoContract.View> {
    @Inject
    ...
    @Inject
    public BusinessBasicInfoPresenter(BusinessBasicInfoContract.Model model, BusinessBasicInfoContract.View rootView) {
