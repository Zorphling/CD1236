...
public class Tips {
    ...
    private static View createTextToastView(String message) {
        ...
        // 创建View
        FrameLayout layout = new FrameLayout(MyApplication.mApp);
        ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        layout.setLayoutParams(layoutParams);
        layout.setPadding(dp2px(16), dp2px(12), dp2px(16), dp2px(12));
        layout.setBackground(drawable);

        TextView textView = new TextView(MyApplication.mApp);
    ...
    private static int dp2px(float dpValue) {
        final float scale = MyApplication.mApp.getResources().getDisplayMetrics().density;
