...
public class AlertDialog {
    ...
    public AlertDialog setNegativeButton(String text, int color, View.OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("");
        } else {
    ...
    private void setLayout() {
        ...
        if (!showPosBtn && !showNegBtn) {
            ...
            btn_pos.setBackgroundResource(R.color.bg_change_item_press);
            btn_pos.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    dismiss();
        ...
        if (showPosBtn && showNegBtn) {
            ...
            btn_neg.setBackgroundResource(R.color.bg_change_item_press);
